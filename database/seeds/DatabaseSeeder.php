...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $transaksibendahara->tanggal = "2020-08-05";
        // $transaksibendahara->keterangan = "Dana";
        // $transaksibendahara->nominal = 14738000;
        // $transaksibendahara->gambar = null;
        // $transaksibendahara->status = true;
        // $transaksibendahara->jenistransaksi_id = 1;
        // $transaksibendahara->user_id = 1;
